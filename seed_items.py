...
def seed_items():
     ...
     items = [
          ...
          # Зелья (результаты варки)
          Item(name="Зелье бодрости", item_type="potion", rarity="common",
               description="Восстанавливает 20 энергии.", sell_price=30),
          Item(name="Лунный эликсир", item_type="potion", rarity="uncommon",
               description="Ускоряет рост растения на 15%.", sell_price=60),
          Item(name="Тёмная настойка", item_type="potion", rarity="rare",
